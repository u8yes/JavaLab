...
<div class="title_left" style="width:100%;margin:0 0 0 0;">
    <h1><img src="<c:url value='/images/egovframework/com/cmm/'/>icon/tit_icon.gif" width="16" height="16" hspace="3" style="vertical-align:middle; display:inline-block;" alt="제목아이콘이미지">&nbsp;설문문항 등록</h1>
</div>
...
<caption>등록 을 제공한다</caption>
  <tr>
    <th scope="row" width="20%" height="23" class="required_text" nowrap><label for="qestnrCn">설문지정보(제목)</label><img src="<c:url value='/images/egovframework/com/cmm/'/>icon/required.gif" alt="필수항목" title="필수항목" width="15" height="15"></th>
    <td width="80%" nowrap>
      ...
      <img src="<c:url value='/images/egovframework/com/cmm/'/>search2.gif" align="middle" style="border:0px" alt="설문지정보" title="설문지정보">
      </a>
  ...
  <tr>
    <th scope="row" width="20%" height="23" class="required_text" nowrap><label for="qestnSn">질문순번</label><img src="<c:url value='/images/egovframework/com/cmm/'/>icon/required.gif" alt="필수항목" title="필수항목" width="15" height="15"></th>
    <td width="80%" nowrap>
  ...
  <tr>
    <th scope="row" width="20%" height="23" class="required_text" nowrap ><label for="qestnTyCode">질문유형</label><img src="<c:url value='/images/egovframework/com/cmm/'/>icon/required.gif" alt="필수항목" title="필수항목" width="15" height="15"></th>
    <td width="80%" nowrap>
...
<select name="qestnTyCode" title="질문유형 선택">
  ...
  <tr>
    <th scope="row" height="23" class="required_text" ><label for="qestnCn">질문 내용</label><img src="<c:url value='/images/egovframework/com/cmm/'/>icon/required.gif" alt="필수항목" title="필수항목" width="15" height="15"></th>
    <td>
  ...
  <tr>
    <th scope="row" width="20%" height="23" class="required_text" nowrap><label for="mxmmChoiseCo">최대선택건수</label><img src="<c:url value='/images/egovframework/com/cmm/'/>icon/required.gif" alt="필수항목" title="필수항목" width="15" height="15"></th>
    <td width="80%" nowrap>

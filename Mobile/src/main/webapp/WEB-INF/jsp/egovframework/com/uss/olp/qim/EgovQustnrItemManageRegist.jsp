...
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%"class="title_left">
   <h1><img src="<c:url value='/images/egovframework/com/cmm/'/>icon/tit_icon.gif" width="16" height="16" hspace="3" align="middle" alt="">&nbsp;설문항목 등록</h1></td>
 </tr>
</table>
...
<tr>
<th scope="row" width="20%" height="23" class="required_text" nowrap>설문정보<img src="<c:url value='/images/egovframework/com/cmm/'/>icon/required.gif" alt="필수항목" title="필수항목" width="15" height="15"></th>
<td width="80%" nowrap>
  <input name="qestnrCn" id="qestnrCn" type="text" size="73" value="" title="설문정보 입력" maxlength="4000" style="width:300px;">
   ...
   <img src="<c:url value='/images/egovframework/com/cmm/'/>search2.gif" onClick=""align="middle" style="border:0px" alt="설문정보" title="설문정보">
   </a>
...
<tr>
<th scope="row" width="20%" height="23" class="required_text" nowrap>설문문항정보<img src="<c:url value='/images/egovframework/com/cmm/'/>icon/required.gif" alt="필수항목" title="필수항목" width="15" height="15"></th>
<td width="80%" nowrap>
  ...
  <img src="<c:url value='/images/egovframework/com/cmm/'/>search2.gif" align="middle" alt="설문문항정보" title="설문문항정보">
  </a>
  <input name="qestnrQesitmId" id="qestnrQesitmId" type="hidden" value="">
</td>
</tr>
<tr>
<th scope="row" height="23" class="required_text" >항목 순번<img src="<c:url value='/images/egovframework/com/cmm/'/>icon/required.gif" alt="필수항목" title="필수항목" width="15" height="15"></th>
<td>
...
<tr>
<th scope="row" height="23" class="required_text" >항목 내용<img src="<c:url value='/images/egovframework/com/cmm/'/>icon/required.gif" alt="필수항목" title="필수항목" width="15" height="15"></th>
<td>
...
<tr>
<th scope="row" width="20%" height="23" class="required_text" nowrap >기타답변여부<img src="<c:url value='/images/egovframework/com/cmm/'/>icon/required.gif" alt="필수항목" title="필수항목" width="15" height="15"></th>
<td width="80%" nowrap>
